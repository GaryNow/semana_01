...
public class Propuesto_1_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		expositor.codigo = 123;
		expositor.nombre = "Now";
		expositor.horasTrabajadas = 100;
		expositor.tarifaHora = 15;
		
		imprimir("Nombre: " + expositor.nombre);
		imprimir("Código: " + expositor.codigo);
		imprimir("Horas trabajadas: " + expositor.horasTrabajadas);
		imprimir("Tarifa por hora: " + expositor.tarifaHora);
		
		imprimir("Sueldo bruto: " + expositor.sueldoBruto());
		imprimir("Descuento por AFP: " + expositor.descuentoAFP());
		imprimir("Descuento por EPS: " + expositor.descuentoEPS());
		imprimir("Salario Neto: " + expositor.sueldoNeto());
	}
